...
class UserProfile(SQLModel, table=True):
    ...
    intent_vector: Optional[List[float]] = Field(
        default=None, sa_column=Column(Vector(256))
    )
    resume_vector: Optional[List[float]] = Field(
        default=None, sa_column=Column(Vector(256))
    )
    github_vector: Optional[List[float]] = Field(
        default=None, sa_column=Column(Vector(256))
    )
    ...
    intent_stack_areas: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(sa.String))
    )
    ...
    resume_job_titles: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(sa.String))
    )
    resume_raw_entities: Optional[Dict[str, Any]] = Field(
    ...
    github_languages: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(sa.String))
    )
    github_topics: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(sa.String))
    )
    ...
    onboarding_status: str = Field(
        default="not_started",
        sa_column=sa.Column(
            sa.String(20), server_default="not_started", nullable=False
        ),
    )
