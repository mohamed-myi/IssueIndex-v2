...
def upgrade() -> None:
    ...
    with op.batch_alter_table("bookmarkedissue", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("bookmarkedissue_user_id_fkey"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            None, "users", ["user_id"], ["id"], referent_schema="public"
        )
    ...
    with op.batch_alter_table("linked_accounts", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_public_linked_accounts_provider"), ["provider"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_public_linked_accounts_user_id"), ["user_id"], unique=False
        )
        batch_op.drop_constraint(
            batch_op.f("linked_accounts_user_id_fkey"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            None, "users", ["user_id"], ["id"], referent_schema="public"
        )
    ...
    with op.batch_alter_table("personalnote", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("personalnote_bookmark_id_fkey"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            None, "bookmarkedissue", ["bookmark_id"], ["id"], referent_schema="public"
        )
    ...
    with op.batch_alter_table("userprofile", schema=None) as batch_op:
        batch_op.alter_column("intent_text", existing_type=sa.VARCHAR(), nullable=True)
        batch_op.alter_column(
            "resume_uploaded_at",
            existing_type=postgresql.TIMESTAMP(timezone=True),
            type_=sa.DateTime(),
        ...
        batch_op.drop_index(
            batch_op.f("ix_userprofile_combined_vector"),
            postgresql_ops={"combined_vector": "vector_cosine_ops"},
            postgresql_with={"m": "16", "ef_construction": "64"},
            postgresql_using="hnsw",
        )
        batch_op.drop_constraint(
            batch_op.f("userprofile_user_id_fkey"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            None, "users", ["user_id"], ["id"], referent_schema="public"
        )
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        batch_op.alter_column(
            "github_node_id", existing_type=sa.VARCHAR(), nullable=True
        )
        batch_op.alter_column(
            "github_username", existing_type=sa.VARCHAR(), nullable=True
        )
        ...
        batch_op.create_index(
            batch_op.f("ix_public_users_email"), ["email"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_public_users_github_node_id"),
            ["github_node_id"],
            unique=True,
        )
    ...
    with op.batch_alter_table("recommendation_events", schema="analytics") as batch_op:
        ...
        batch_op.drop_constraint(
            batch_op.f("uq_recommendation_events_event_id"), type_="unique"
        )
        batch_op.drop_index(
            batch_op.f("uq_recommendation_events_impression_composite"),
            postgresql_where="(event_type = 'impression'::text)",
        )
        batch_op.create_index(
            batch_op.f("ix_analytics_recommendation_events_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_analytics_recommendation_events_event_type"),
            ["event_type"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_analytics_recommendation_events_issue_node_id"),
            ["issue_node_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_analytics_recommendation_events_recommendation_batch_id"),
            ["recommendation_batch_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_analytics_recommendation_events_user_id"),
            ["user_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("issue", schema="ingestion") as batch_op:
        ...
        batch_op.drop_index(
            batch_op.f("ix_issue_embedding_hnsw"),
    ...
    with op.batch_alter_table("repository", schema="ingestion") as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_ingestion_repository_full_name"), ["full_name"], unique=True
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("repository", schema="ingestion") as batch_op:
        ...
        batch_op.create_unique_constraint(
            batch_op.f("uq_repository_full_name"),
            ["full_name"],
    ...
    with op.batch_alter_table("issue", schema="ingestion") as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_ingestion_issue_github_created_at"),
            ["github_created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_ingestion_issue_content_hash"),
            ["content_hash"],
            unique=False,
        )
        batch_op.alter_column(
    ...
    with op.batch_alter_table("recommendation_events", schema="analytics") as batch_op:
        ...
        batch_op.create_unique_constraint(
            batch_op.f("uq_recommendation_events_event_id"),
            ["event_id"],
            postgresql_nulls_not_distinct=False,
        )
        batch_op.create_index(
            batch_op.f("ix_recommendation_events_user_id"), ["user_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_recommendation_events_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_recommendation_events_batch_id"),
            ["recommendation_batch_id"],
            unique=False,
        )
        batch_op.alter_column(
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            batch_op.f("uq_users_email_provider"),
            ["email", "created_via"],
            postgresql_nulls_not_distinct=False,
        )
        batch_op.create_index(
        ...
        batch_op.alter_column(
            "github_username", existing_type=sa.VARCHAR(), nullable=False
        )
        batch_op.alter_column(
            "github_node_id", existing_type=sa.VARCHAR(), nullable=False
        )

    with op.batch_alter_table("userprofile", schema=None) as batch_op:
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            batch_op.f("userprofile_user_id_fkey"), "users", ["user_id"], ["id"]
        )
        batch_op.create_index(
            batch_op.f("ix_userprofile_combined_vector"),
            ["combined_vector"],
        ...
        batch_op.alter_column("intent_text", existing_type=sa.VARCHAR(), nullable=False)

    with op.batch_alter_table("session", schema=None) as batch_op:
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            batch_op.f("session_user_id_fkey"), "users", ["user_id"], ["id"]
        )
        batch_op.create_index(
            batch_op.f("ix_session_user_expires"),
            ["user_id", "expires_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_session_user_created"),
            ["user_id", "created_at"],
            unique=False,
        )
        batch_op.alter_column(
    ...
    with op.batch_alter_table("personalnote", schema=None) as batch_op:
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            batch_op.f("personalnote_bookmark_id_fkey"),
            "bookmarkedissue",
            ["bookmark_id"],
            ["id"],
        )
    ...
    with op.batch_alter_table("linked_accounts", schema=None) as batch_op:
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            batch_op.f("linked_accounts_user_id_fkey"),
            "users",
            ["user_id"],
            ["id"],
            ondelete="CASCADE",
        ...
        batch_op.create_index(
            batch_op.f("ix_linked_accounts_provider"), ["provider"], unique=False
        )
        batch_op.alter_column(
            "revoked_at",
            existing_type=sa.DateTime(),
    ...
    with op.batch_alter_table("bookmarkedissue", schema=None) as batch_op:
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            batch_op.f("bookmarkedissue_user_id_fkey"), "users", ["user_id"], ["id"]
        )
    ...
    with op.batch_alter_table("search_interactions", schema="analytics") as batch_op:
        batch_op.create_index(
            batch_op.f("ix_search_interactions_user_id"), ["user_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_search_interactions_search_id"), ["search_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_search_interactions_created_at"),
            ["created_at"],
            unique=False,
        )
