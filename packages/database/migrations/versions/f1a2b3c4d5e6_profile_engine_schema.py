...
def upgrade() -> None:
    ...
    op.alter_column(
        "userprofile", "raw_intent_text", new_column_name="intent_text", schema="public"
    )
    ...
    op.add_column(
        "userprofile", sa.Column("github_data", JSONB, nullable=True), schema="public"
    )
    op.add_column(
        "userprofile",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "user_id", "provider", name="uq_linked_accounts_user_provider"
        ),
        schema="public",
    )

    op.create_index(
        "ix_linked_accounts_user_id", "linked_accounts", ["user_id"], schema="public"
    )
    op.create_index(
        "ix_linked_accounts_provider", "linked_accounts", ["provider"], schema="public"
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_linked_accounts_provider", table_name="linked_accounts", schema="public"
    )
    op.drop_index(
        "ix_linked_accounts_user_id", table_name="linked_accounts", schema="public"
    )
    ...
    # Rename columns back
    op.alter_column(
        "userprofile", "intent_text", new_column_name="raw_intent_text", schema="public"
    )
    op.alter_column(
        "userprofile",
        "resume_vector",
