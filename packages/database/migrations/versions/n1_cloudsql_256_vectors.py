...
def upgrade() -> None:
    ...
    op.drop_index("ix_ingestion_issue_github_created_at", table_name="issue", schema="ingestion")
    op.drop_index("ix_ingestion_issue_ingested_at", table_name="issue", schema="ingestion")
    op.drop_index("ix_ingestion_issue_survival_score", table_name="issue", schema="ingestion")
    ...
    op.drop_index("ix_ingestion_repository_last_scraped_at", table_name="repository", schema="ingestion")
    op.drop_index("ix_ingestion_repository_stargazer_count", table_name="repository", schema="ingestion")
    op.drop_index("ix_ingestion_repository_primary_language", table_name="repository", schema="ingestion")
    op.drop_index("ix_ingestion_repository_full_name", table_name="repository", schema="ingestion")
    ...
    op.create_table(
        ...
        sa.Column("issue_velocity_week", sa.Integer(), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("has_template_headers", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column("tech_stack_weight", postgresql.REAL(), nullable=False, server_default="0.0"),
        # Calculated scores
        sa.Column("q_score", postgresql.REAL(), nullable=False, server_default="0.0"),
        sa.Column("survival_score", postgresql.REAL(), nullable=False, server_default="0.0"),
        # Content
        ...
        sa.Column("embedding", sa.String(), nullable=True),  # Will be cast to vector(256)
        # Idempotency
    ...
    op.execute("ALTER TABLE ingestion.issue ALTER COLUMN embedding TYPE vector(256) USING embedding::vector(256)")
    ...
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN intent_vector TYPE vector(256)")
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN resume_vector TYPE vector(256)")
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN github_vector TYPE vector(256)")
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN combined_vector TYPE vector(256)")
...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN intent_vector TYPE vector(768)")
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN resume_vector TYPE vector(768)")
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN github_vector TYPE vector(768)")
    op.execute("ALTER TABLE public.userprofile ALTER COLUMN combined_vector TYPE vector(768)")
    ...
    op.drop_index("ix_ingestion_issue_content_hash", table_name="issue", schema="ingestion")
    op.drop_index("ix_issue_survival_vacuum", table_name="issue", schema="ingestion")
    op.drop_index("ix_ingestion_issue_state", table_name="issue", schema="ingestion")
    op.drop_index("ix_ingestion_issue_github_created_at", table_name="issue", schema="ingestion")
    op.drop_index("ix_ingestion_issue_ingested_at", table_name="issue", schema="ingestion")
    ...
    op.create_index("ix_ingestion_repository_full_name", "repository", ["full_name"], schema="ingestion")
    op.create_index("ix_ingestion_repository_primary_language", "repository", ["primary_language"], schema="ingestion")
    op.create_index("ix_ingestion_repository_stargazer_count", "repository", ["stargazer_count"], schema="ingestion")
    op.create_index("ix_ingestion_repository_last_scraped_at", "repository", ["last_scraped_at"], schema="ingestion")
    ...
    op.execute("ALTER TABLE ingestion.issue ALTER COLUMN embedding TYPE vector(768) USING embedding::vector(768)")
    
    op.create_index("ix_ingestion_issue_repo_id", "issue", ["repo_id"], schema="ingestion")
    op.create_index("ix_ingestion_issue_q_score", "issue", ["q_score"], schema="ingestion")
    op.create_index("ix_ingestion_issue_survival_score", "issue", ["survival_score"], schema="ingestion")
    op.create_index("ix_ingestion_issue_ingested_at", "issue", ["ingested_at"], schema="ingestion")
    op.create_index("ix_ingestion_issue_github_created_at", "issue", ["github_created_at"], schema="ingestion")
    op.create_index("ix_ingestion_issue_state", "issue", ["state"], schema="ingestion")
    op.create_index("ix_issue_survival_vacuum", "issue", ["survival_score", "ingested_at"], schema="ingestion")
