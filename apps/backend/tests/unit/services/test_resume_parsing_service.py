...
class TestValidateFile:
    ...
    def test_rejects_txt_extension(self):
        from src.services.resume_parsing_service import validate_file, UnsupportedFormatError
    ...
    def test_rejects_file_over_5mb(self):
        from src.services.resume_parsing_service import validate_file, FileTooLargeError, MAX_FILE_SIZE
    ...
    def test_accepts_file_at_exactly_5mb(self):
        from src.services.resume_parsing_service import validate_file, MAX_FILE_SIZE
...
class TestExtractEntities:
    ...
    def test_uses_correct_labels(self):
        from src.services.resume_parsing_service import extract_entities, ENTITY_LABELS
...
class TestProcessResume:
    ...
    async def test_raises_on_invalid_format(self):
        from src.services.resume_parsing_service import process_resume, UnsupportedFormatError
    ...
    async def test_raises_on_file_too_large(self):
        from src.services.resume_parsing_service import process_resume, FileTooLargeError, MAX_FILE_SIZE
...
class TestGetResumeData:
    ...
    async def test_returns_data_when_populated(self):
        ...
        mock_profile.resume_uploaded_at = datetime(2026, 1, 4, 12, 0, 0, tzinfo=timezone.utc)
...
class TestDeleteResume:
    ...
    async def test_clears_all_resume_fields(self):
        ...
        mock_profile.resume_uploaded_at = datetime.now(timezone.utc)
        mock_profile.resume_vector = [0.1] * 768
        mock_profile.intent_vector = None
        mock_profile.github_vector = None
