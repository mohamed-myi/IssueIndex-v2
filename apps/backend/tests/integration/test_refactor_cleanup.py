...
class TestEmbeddingDimIs256:
    ...
    def test_embeddings_module_dim_is_256(self):
        ...
        from src.ingestion.embeddings import EMBEDDING_DIM
    ...
    def test_nomic_moe_embedder_dim_is_256(self):
        ...
        from src.ingestion.nomic_moe_embedder import EMBEDDING_DIM
    ...
    def test_embedding_dim_constants_are_consistent(self):
        ...
        from src.core.config import get_settings
        from src.ingestion.embeddings import EMBEDDING_DIM as EMBEDDINGS_DIM
        from src.ingestion.nomic_moe_embedder import EMBEDDING_DIM as NOMIC_DIM
