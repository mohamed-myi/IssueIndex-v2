...
from ingestion.nomic_moe_embedder import NomicMoEEmbedder
from ingestion.pubsub_consumer import IssueEmbeddingConsumer
...
async def run_embedding_worker() -> None:
    ...
    try:
        ...
        while not shutdown.should_stop:
            ...
            # Nack failed messages (will be retried or sent to DLQ)
            if nack_ids:
